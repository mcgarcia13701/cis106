...
1. What is the name of the distribution and the OS Type: 
   * **The name of the distribution is Webconverger and the OS type is Linux.**
...
* Distro Name: **Trisquel GNU / Linux**
* Website: **http://trisquel.info/**
* Desktop Environment: **KDE Plasma, LXDE, MATE**
